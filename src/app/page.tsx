          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                Professional mobile massage therapy services for your wellness
                journey. Experience the difference of personalized care in the
            ...
            <div>
              ...
              <p className="text-gray-300 mb-2">
                Email: needleandkneadservices@gmail.com
              </p>
              <p className="text-gray-300 mb-4">
                Mobile massage therapy serving your area
              </p>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a
                    href="https://www.instagram.com/needle.knead"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-300 hover:text-amber-400 transition-colors duration-300 transform hover:scale-110"
                ...
                <p className="text-xs text-gray-400 mt-2">@needle.knead</p>
              </div>
            </div>
          </div>
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Needle & Knead. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </main>
